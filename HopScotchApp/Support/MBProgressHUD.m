...
- (void)updateUIForKeypath:(NSString *)keyPath {
	if ([keyPath isEqualToString:@"mode"] || [keyPath isEqualToString:@"customView"]) {
		...
		if ([indicator respondsToSelector:@selector(setProgress:)]) {
            NSLog(@"%@",@"Had to disable the progress indicator due to an incompatibility with MailCore");
            //Import <objc/message.h>, link with libobjc.dylib and call
            //obj_msgSend((id)indicator,@selector(setProgress:), *(int*)&progress);
